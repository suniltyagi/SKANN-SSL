...
\setstretch{1.2}
\begin{document}
\title{SKANN-SSL --- Parametric Sea-Noise Model from Digitised Knudsen Curves}
...
\section*{Python Implementation Used.}
...
\section*{6. Turbulence Region (10 Hz–)}
...
\section*{7. Low–Frequency Region (–200 Hz)}
...
\section*{9. Mid–Frequency Region (200–500 Hz)}
